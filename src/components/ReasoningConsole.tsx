...
export const ReasoningConsole = ({ runId, onComplete, maxNodes }: ReasoningConsoleProps) => {
                                        ...
                                        <div className="mt-3 space-y-4 animate-in slide-in-from-top-2 duration-200">
                                            ...
                                            {step.professors && step.professors.length > 0 && (
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                    {step.professors.slice(0, maxNodes).map((prof, idx) => {
                                                    ...
                                                    {step.professors.length > maxNodes && (
                                                        <div className="col-span-full text-center text-xs text-muted-foreground py-2 italic">
                                                            ...and {step.professors.length - maxNodes} more candidates analyzed
                                                        </div>
                                                    )}
                                                </div>
                                            )}
